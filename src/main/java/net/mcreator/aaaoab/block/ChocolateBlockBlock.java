...
public class ChocolateBlockBlock extends AaaoabModElements.ModElement {
	@ObjectHolder("aaaoab:chocolate_block")
	public static final Block block = null;
	public ChocolateBlockBlock(AaaoabModElements instance) {
		super(instance, 27);
	}
