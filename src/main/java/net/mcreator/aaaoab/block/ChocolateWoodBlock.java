...
public class ChocolateWoodBlock extends AaaoabModElements.ModElement {
	@ObjectHolder("aaaoab:chocolate_wood")
	public static final Block block = null;
	public ChocolateWoodBlock(AaaoabModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chocolate_wood");
		}
