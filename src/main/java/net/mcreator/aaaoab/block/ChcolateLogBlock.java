...
public class ChcolateLogBlock extends AaaoabModElements.ModElement {
	@ObjectHolder("aaaoab:chcolate_log")
	public static final Block block = null;
	public ChcolateLogBlock(AaaoabModElements instance) {
		super(instance, 45);
	}
