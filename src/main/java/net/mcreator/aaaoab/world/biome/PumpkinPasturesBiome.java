...
public class PumpkinPasturesBiome extends AaaoabModElements.ModElement {
	@ObjectHolder("aaaoab:pumpkin_pastures")
	public static final CustomBiome biome = null;
	public PumpkinPasturesBiome(AaaoabModElements instance) {
		super(instance, 1);
	}
	...
	static class CustomBiome extends Biome {
		public CustomBiome() {
			...
			setRegistryName("pumpkin_pastures");
			...
			addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
					new CustomTreeFeature()
							.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.DARK_OAK_LOG.getDefaultState()),
									new SimpleBlockStateProvider(Blocks.OAK_LEAVES.getDefaultState()))).baseHeight(4)
