...
public class PumpkinSingleStructure extends AaaoabModElements.ModElement {
	public PumpkinSingleStructure(AaaoabModElements instance) {
		super(instance, 2);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 100000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("aaaoab", "single_pumpkin"));
						if (template == null)
							return false;
