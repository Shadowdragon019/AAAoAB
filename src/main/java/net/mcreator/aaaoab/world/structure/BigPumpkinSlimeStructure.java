...
public class BigPumpkinSlimeStructure extends AaaoabModElements.ModElement {
	public BigPumpkinSlimeStructure(AaaoabModElements instance) {
		super(instance, 7);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 500) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("aaaoab", "big_pumpkin_slime"));
						if (template == null)
							return false;
