...
public class BigPumpkinSkeletonStructure extends AaaoabModElements.ModElement {
	public BigPumpkinSkeletonStructure(AaaoabModElements instance) {
		super(instance, 5);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 1000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("aaaoab", "big_pumpkin_skeleton"));
						if (template == null)
							return false;
