...
import net.mcreator.aaaoab.procedures.PumpkinPasturesHouseOnStructureInstanceGeneratedProcedure;
...
public class PumpkinPasturesHouseStructure extends AaaoabModElements.ModElement {
	public PumpkinPasturesHouseStructure(AaaoabModElements instance) {
		super(instance, 11);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 500) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("aaaoab", "pumpkin_pastures_house"));
						if (template == null)
							return false;
								...
								.addProcessor(BlockIgnoreStructureProcessor.STRUCTURE_BLOCK).setChunk(null).setIgnoreEntities(false));
						{
							...
							PumpkinPasturesHouseOnStructureInstanceGeneratedProcedure.executeProcedure($_dependencies);
						}
					}
				}
				return true;
