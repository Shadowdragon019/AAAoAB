...
public class PumpkinCarvedSingleStructure extends AaaoabModElements.ModElement {
	public PumpkinCarvedSingleStructure(AaaoabModElements instance) {
		super(instance, 3);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 100000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("aaaoab", "single_pumpkin_carved"));
						if (template == null)
							return false;
