...
public class BigPumpkinStructure extends AaaoabModElements.ModElement {
	public BigPumpkinStructure(AaaoabModElements instance) {
		super(instance, 4);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 7500) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("aaaoab", "big_pumpkin"));
						if (template == null)
							return false;
