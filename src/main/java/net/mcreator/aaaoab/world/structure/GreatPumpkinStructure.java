...
public class GreatPumpkinStructure extends AaaoabModElements.ModElement {
	public GreatPumpkinStructure(AaaoabModElements instance) {
		super(instance, 10);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 1000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("aaaoab", "great_pumpkin"));
						if (template == null)
							return false;
