...
import net.mcreator.aaaoab.procedures.ChocolateTreeNormalOnStructureInstanceGeneratedProcedure;
import net.mcreator.aaaoab.procedures.ChocolateTreeNormalAdditionalGenerationConditionProcedure;
...
public class ChocolateTreeNormalStructure extends AaaoabModElements.ModElement {
	public ChocolateTreeNormalStructure(AaaoabModElements instance) {
		super(instance, 53);
	}
			...
			public boolean place(IWorld world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
				...
				if ((random.nextInt(1000000) + 1) <= 1000000) {
					...
					for (int a = 0; a < count; a++) {
						...
						int y = spawnTo.getY();
						int z = spawnTo.getZ();
						if (!ChocolateTreeNormalAdditionalGenerationConditionProcedure.executeProcedure(ImmutableMap.of("y", y)))
							continue;
