...
public class BigPumpkinZombieStructure extends AaaoabModElements.ModElement {
	public BigPumpkinZombieStructure(AaaoabModElements instance) {
		super(instance, 6);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 1000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("aaaoab", "big_pumpkin_zombie"));
						if (template == null)
							return false;
